...
([
    ...
    function(module, exports, __webpack_require__) {
        ...
        __vue_options__.__file = "/usr/src/app/raw/07d2e8fe4b48314aa0e1b4a5404553d4.native.entry.vue"
        ...
        exports.default = {
            ...
            created: function created() {
                ...
                storage.getItem('serviceId', function(event) {
                    console.log('account_serviceId:', event.data);
                    vm.user_serviceId = event.data;
                    console.log('vm.user_serviceId: ' + vm.user_serviceId);
                    stream.fetch({
                        headers: {
                            'Cookie': '_serviceId=' + event.data
                        },
                        method: 'POST',
                        type: 'json',
